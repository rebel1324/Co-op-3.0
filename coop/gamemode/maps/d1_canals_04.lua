...
if SERVER then
	...
	hook.Add("InitPostEntity", "custom_map", function()
		...
		obj1:SetKeyValue("origin",  "4213.50 3087.65 -474.89")
		...
		obj2:SetKeyValue("origin",  "7220.07 1557.22 -447.96")
